...
local enable_screenWatcher = true -- checks if new connection is added/ removed
...
function turnOffAfterInputCheck()
...
function set_mac_connection()
  bscpy_exec_command("set_input "..tv_input)
